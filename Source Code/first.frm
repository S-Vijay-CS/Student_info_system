...
Begin VB.Form first 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.Label Label1 
         ...
         Caption         =   "SEMESTER 1 MARK DETAILS"
         BeginProperty Font 
...
cn.Open
rs.Open "select * from Sem1", cn, adOpenDynamic, adLockPessimistic
