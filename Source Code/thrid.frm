...
Begin VB.Form thrid 
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.Label Label1 
         ...
         Caption         =   "SEMSTER 3 MARK DETAILS"
         BeginProperty Font 
...
cn.Open
rs.Open "select * from Sem3", cn, adOpenDynamic, adLockPessimistic
