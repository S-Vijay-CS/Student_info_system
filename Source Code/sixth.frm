...
Begin VB.Form sixth 
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.Label Label1 
         ...
         Caption         =   "SEMESTER 6 MARK DETAILS"
         BeginProperty Font 
...
cn.Open
rs.Open "select * from Sem6", cn, adOpenDynamic, adLockPessimistic
