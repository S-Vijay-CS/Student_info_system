...
Begin VB.Form forth 
   ...
   Begin VB.PictureBox Picture2 
      ...
      Begin VB.Label Label1 
         ...
         Caption         =   "SEMESTER 4 MARK DETAILS"
         BeginProperty Font 
...
cn.Open
rs.Open "select * from Sem4", cn, adOpenDynamic, adLockPessimistic
